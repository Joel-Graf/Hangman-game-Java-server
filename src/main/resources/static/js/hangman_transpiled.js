...
function Hangman() {
  ...
  function getGameInProgress() {
    return fetch("game/game_in_progress").then(res => res.json()).then(game => {
      if (game != {}) {
        updateGame(game);
      }
    }).catch(err => {
  ...
  function correctWord() {
    return fetch("game/correct_word").then(res => {
      return new Promise((resolve, reject) => {
        res.json().then(res => resolve(res)).catch(() => {
          resolve({});
        });
      });
    }).then(game => {
  ...
  function incorrectWord() {
    return fetch("game/incorrect_word").then(res => {
      return new Promise((resolve, reject) => {
        res.json().then(res => resolve(res)).catch(() => {
          resolve({});
        });
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "header"
  }, /*#__PURE__*/React.createElement("h4", null, "Vidas: ", lifes), /*#__PURE__*/React.createElement("h2", null, "Tentativas Restantes: ", remaningAttempts), /*#__PURE__*/React.createElement("h3", null, "Palavras inseridas:", " ", inputLettersHistory.map((letter, index) => /*#__PURE__*/React.createElement("span", {
    key: `${letter}:${index}`
  }, letter.toUpperCase())))), /*#__PURE__*/React.createElement("div", {
    className: "display"
  }, /*#__PURE__*/React.createElement("h1", null, anonWordArray.map((letter, index) => /*#__PURE__*/React.createElement("span", {
    style: {
      marginLeft: 6
    },
    key: letter + `${index}`
  }, " ", `${letter}`, " ")))), /*#__PURE__*/React.createElement("form", {
    className: "form",
    onSubmit: e => {
      e.preventDefault();
